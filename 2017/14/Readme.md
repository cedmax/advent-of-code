...
<p>The disk in question consists of a 128x128 grid; each square of the grid is either <em>free</em> or <em>used</em>. On this disk, the state of the grid is tracked by the bits in a sequence of <a href="https://github.com/cedmax/advent-of-code/tree/main/2017/10">knot hashes</a>.</p>
