...
var fs = require( 'fs' );
var input = fs.readFileSync( 'input/02.txt', 'utf-8' );
...
function neededPaper( sides ) {
	return sides.reduce( function( a, b ) {return a + b;} ) + Math.min.apply( Math, sides ) / 2;
}
...
console.log( calculateNeededPaper( input.split( '\n' )));
...
function neededRibbon( dimensions ) {
	...
	var shortesPerimeter = dimensions.reduce( function( a, b ) {return a + b;} ) * 2;
...
console.log( calculateNeededRibbon( input.split( '\n' )));
